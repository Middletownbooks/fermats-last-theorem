...
10. Do not quote the product-law 2x2 or the union-bound 2x2 as results until a baseline exists. They are raw accuracies, and this programme's own rule is lift over a baseline, never raw accuracy. The telegraph arm has never been run.
