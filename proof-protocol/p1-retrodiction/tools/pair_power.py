...
def main() -> None:
    ...
    print("  (Kelley-Meka against Bloom-Sisask) does NOT count toward the five: both halves are")
    print("  must-not-fire, so there is no 'which is which' to score. It tests specificity inside one")
    print("  problem-period instead, which is worth having and is a different number. Every")
